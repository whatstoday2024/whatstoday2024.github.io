<template>
  <div class="bg-white fixed-top w-100">
          ...
          >
            ...
            >
              <ul class="navbar-nav align-items-center" data-bs-dismiss="offcanvas">
                ...
                <li v-if="isLogin" class="nav-item mx-2 d-none d-md-block">
                  <div class="dropdown">
                    ...
                    <ul
                      class="dropdown-menu text-small shadow dropdown-menu-end m-2"
              ...
              <div class="d-flex flex-column flex-md-row" data-bs-dismiss="offcanvas">
                ...
                <ul
                  v-if="isLogin"
                  class="navbar-nav text-center align-items-center d-block d-md-none"
                >
                  <li class="nav-item">
                ...
                <RouterLink
                  v-if="!isLogin"
                  to="/login"
                  class="btn btn-brand-blue rounded-pill"
