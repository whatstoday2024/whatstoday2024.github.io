        ...
        <div class="modal-body row m-0 row-cols-1 row-cols-lg-2">
          <div class="bento-description col-lg-4 order-last order-lg-1 row m-0 p-lg-3">
            ...
            <div v-if="path === '/menu'" class="btns text-center p-3 col-6 col-lg-12">
              <button type="button" class="btn btn-outline-primary re-generate-btn px-4 py-3 m-2" data-bs-dismiss="modal"
                @click="openModal(confirmRegenerateModal)" title="重新生成便當">重新生成便當</button>
              <button type="button" class="btn btn-primary save-to-diary-btn px-4 py-3 m-2" data-bs-dismiss="modal"
                @click="openModal(saveToBentoDiaryModal)" :title="memberData.id ? '存至便當日記' : '便當日記為會員限定功能'"
            ...
            <div v-if="path === '/member/bento-diary'" class="btns text-center p-3 col-6 col-lg-12">
              ...
              <button type="button" class="btn btn-outline-primary re-generate-btn px-4 py-3 m-2" data-bs-dismiss="modal"
                @click="openModal(confirmDeleteRecordModal)" title="刪除此便當紀錄">刪除此便當紀錄</button>
            </div>
          </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" aria-label="Cancel and Return" data-bs-dismiss="modal"
            @click="openModal(bentoModal)">取消</button>
          <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="generateBento">確認</button>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mb-3">
            ...
            <input class="form-control me-4 w-auto d-inline-block" id="bentoDate" type="date" v-model="bentoDate">
          </div>
          <div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" aria-label="Cancel and Return" data-bs-dismiss="modal"
            @click="openModal(bentoModal)">取消</button>
          <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="saveToDiary">確認儲存</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" aria-label="Cancel and Return" data-bs-dismiss="modal"
            @click="openModal(bentoModal)">取消</button>
          <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click="deleteRecord">確認</button>
        </div>
      </div>
    </div>
  </div>
