        ...
        <div class="cards row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-5 g-4">
            <div class="col" v-for="dish in dishesList" :key="dish.title">
                <div class="card h-100">
                    <img :src="dish.imgUrl" height="120rem" class="card-img-top object-fit-cover"
                         :alt="dish.title + '的圖片'">
                    <div class="card-body dish-info mx-auto px-0 py-3 w-80 d-flex flex-column justify-content-between">
                        <div class="dish-info-btn btn p-0 d-flex" @click="dishInfo = dish">
                            <i class="fa-solid fa-circle-info text-secondary fs-5 lh-sm" title="菜色介紹"
                               data-bs-toggle="modal" :data-bs-target="'#' + modalName"></i>
                        </div>
                        ...
                        <div class="input-group mx-auto">
                            <div class="input-group-text" :class="{ 'bg-primary-mid': dish.isLoading === true }">
                                <input class="form-check-input mt-0" type="checkbox"
                                       ...
                                       @change="updateSelected(dish)"
                                       :disabled="mode === 'default' || dish.isLoading === true">
                            </div>
                            <select class="form-select" :class="{ 'bg-primary-light': dish.isLoading === true }"
                                    aria-label="Default select example" v-model="dish.preferenceLevel"
                                    @change="updatePreferenceLevel(dish)"
            ...
            <div class="modal-content dish">
                ...
                <div class="modal-body">
                    <div class="row row-cols-1 row-cols-lg-2">
                        <div
                             class="col order-last order-lg-1 row row-cols-1 gap-3 mt-0 py-3 px-0 mx-auto justify-content-center">
                            ...
                            <div class="col row align-items-center">
                                ...
                                <div class="col">
                                    <select class="form-select w-75" aria-label="Default select example"
                                            :disabled="!dishInfo.isChecked" v-model="dishInfo.preferenceLevel">
